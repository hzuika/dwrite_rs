...
use windows::Win32::Graphics::DirectWrite::{
    DWriteCreateFactory, IDWriteFactory7, IDWriteLocalizedStrings, DWRITE_FACTORY_TYPE_ISOLATED,
...
fn run(
    ...
    unsafe {
        let factory: IDWriteFactory7 = DWriteCreateFactory(DWRITE_FACTORY_TYPE_ISOLATED)?;
        ...
        let collection =
            factory.GetSystemFontCollection4(include_downloadable_fonts, model.get_model())?;
